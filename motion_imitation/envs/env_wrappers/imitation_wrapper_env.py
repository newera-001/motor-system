...
class ImitationWrapperEnv(object):
    ...
    def __init__(self, gym_env, episode_length_start=1000,
    ...
    def reset(self, initial_motor_angels=None, reset_duration = 0.0):
        ...
        """
        original_observation = self._gym_env.reset(initial_motor_angels, reset_duration)
        observation = self._modify_observation(original_observation)
    ...
    def _modify_observation(self,original_observation):
        ...
        """
        target_observation = self._task.build_target_obs() # reference
    ...
    def _enable_curriculum(self)-> bool:
