...
For training：
```
python motion_imitation/run_torch.py --mode train --motion_file 'dog_pace.txt|dog_spin.txt' --int_save_freq 10000000 --visualize --num_envs 50
```
* mode: train or test
...
## Extra work
In this project, I donot use Gaussian distribution to fitting the encoder rather by using a mlp network with one hidden layer. And now I am testing the performance.
